...
export default function Index() {
    return (
        <div className="p-4 gap-y-4 flex flex-col">
            ...
            <p className="text-lg">The <code>client</code> subdirectory is a standard React application based on the <code>Vite</code> template. If you open a command prompt in that directory, you can run <code>npm</code> commands such as <code>npm test</code> or <code>npm install</code>.</p>
        </div>
    );
}
